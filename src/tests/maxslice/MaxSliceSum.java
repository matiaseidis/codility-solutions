...
public class MaxSliceSum {
    ...
    public static void main(String[] args) {
        test(new int[]{3, 2, -6, 4, 0}, 5);
    }

    private static void test(int[] ints, int i) {
        int result = solution(ints);
        System.out.println(String.format("ok: %s - result: %s - expected: %s", result == i, result, i));
    }
